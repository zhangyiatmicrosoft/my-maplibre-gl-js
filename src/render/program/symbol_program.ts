...
export type SymbolIconUniformsType = {
    ...
    'u_matrix_adjusted': UniformMatrix4f;
    ...
    'u_translation_adjusted': Uniform2f;
...
const symbolIconUniforms = (context: Context, locations: UniformLocations): SymbolIconUniformsType => ({
    ...
    'u_matrix_adjusted': new UniformMatrix4f(context, locations.u_matrix_adjusted),
    ...
    'u_translation_adjusted': new Uniform2f(context, locations.u_translation_adjusted),
...
const symbolIconUniformValues = (
    ...
    translationAdjusted: [number, number],
    isText: boolean,
    ...
    return {
        ...
        'u_matrix': matrix,
        'u_matrix_adjusted': matrixAdjusted,
        ...
        'u_translation_adjusted': translationAdjusted,
...
const symbolSDFUniformValues = (
    ...
    return extend(symbolIconUniformValues(functionType, size,
        rotateInShader, pitchWithMap, painter, matrix, matrixAdjusted, labelPlaneMatrix,
        glCoordMatrix, translation, translationAdjusted, isText, texSize, pitchedScale), {
...
const symbolTextAndIconUniformValues = (
    ...
    return extend(symbolSDFUniformValues(functionType, size,
        rotateInShader, pitchWithMap, painter, matrix, matrixAdjusted, labelPlaneMatrix,
        glCoordMatrix, translation, translationAdjusted, true, texSizeSDF, true, pitchedScale), {
